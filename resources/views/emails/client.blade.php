...
<div class="container">
    ...
    <div class="content" style="background: #f9f9f9; padding: 15px; border-radius: 5px;">
        <center><span style="font-size: 18px; font-weight: bold; color: #d9534f;">{{ $data['code'] }}</span></center>
    </div>

    <div class="footer">
        <p>Bienvenue sur GesPer 🎉 ! Nous vous offrons un service de gestion optimale de vos fonds afin de vous aidez au mieux à minimiser vos dépenses quotidienne 😊.</p>
        <!-- <p><a href="https://medautomaticsolutions.fr">Visitez notre site</a></p> -->
    </div>
</div>
